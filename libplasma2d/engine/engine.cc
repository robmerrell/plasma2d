...
void p2d::Engine::initialize(std::string _system_resource_path, std::string _user_resource_path, std::string _debug_host) {
    ...
    if (luaWrapper.setDebugHost(_debug_host)) stopProcessing();
